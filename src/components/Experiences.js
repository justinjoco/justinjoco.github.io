        ...
        <Container fluid style={{ padding: '20px' }}>
            ...
            <VerticalTimeline>
                ...
                >
                    ...
                    <p> Design, implement, and deploy T-Mobile Visual Voicemail's (VVM) new back-end services across multiple clusters to handle ~25 million active users and 600 average TPS, devising and improving the core logic for audio transcoding</p>
