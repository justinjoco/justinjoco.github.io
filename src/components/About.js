...
const About = (props) => {
  ...
  return (
        <Container fluid style={{ textAlign: 'center', color: '#ffffff', padding: '20px' }}>
          ...
          <p >I enjoy learning new things by tackling different challenges. I’ve gained a breadth of skill <B> in mobile/web development, embedded systems, microservice development</B>, <B>machine learning </B>, and <B>distributed systems</B> through previous experiences, hackathons, and class projects by applying <I> data structures, algorithms, and object-oriented principles</I>.
