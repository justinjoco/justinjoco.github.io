...
const More = (props) => {
    ...
    return (    
        <Container fluid style={{textAlign:"center",  padding: "20px",backgroundColor:"#ffffff", color: "#000000"}}>
            <Row>
                <Col>
                <a href="#projects"><FaLaptopCode size={"10vh"} color={projColor} onMouseEnter={() => setProjColor("#696969")} onMouseLeave={() => setProjColor("#292929")}/></a>
                <br/> <br/>
                <h2 >Projects</h2>
                ...
                <Col>
                <a href="#experiences"><FaIndustry size={"10vh"} color={expColor} onMouseEnter={() => setExpColor("#696969")} onMouseLeave={() => setExpColor("#292929")}/></a>
                <br/> <br/>
                <h2 >Experiences</h2>
